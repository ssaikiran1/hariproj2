...
<form action="CustomerController" method="get" name="customerform" class="basic-grey" onsubmit="return registrationMandatory()">
    ...
    <label>
     ...
     <label>
        ...
        <input type="text" name="addressproofid" id="addressproofid" maxlength="10"/>
...
<%}else{%>
<script>if(window.confirm('You are not a field officer')) 
					  		{window.location = 'home.jsp';}
					  		else{window.location = 'home.jsp';}
					  		</script>
<noscript>You are not field officer</noscript>
<% }%>
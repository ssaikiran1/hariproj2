...
{
%>
<form action="CustomerController" method="get" name="customerIdform" class="basic-grey" onsubmit="return idMandatory()">
    <h1> 
        Update Customer
    </h1>
    <label>
...
%>
<br>
<form action="CustomerController" method="get" name="customerform" class="basic-grey" onsubmit="return registrationMandatory()">
    <h1> 
        Update Customer
    </h1>
    ...
    <label>
     ...
     <label>
        <span>Address Proof ID :<sup><font color="red">*</font></sup></span>
         <input type="text" name="addressproofid" value="<%=customer.getAddressproofid()%>" id="addressproofid" maxlength="10"/>
        <p id="adreid"><%if(request.getAttribute("adid")!=null && request.getAttribute("adid").toString().equals("adid")){out.print("Address Proof ID must be filled."); } %></p>
    </label>
    <br>   
   <center>
        <span>&nbsp;</span> 
